...
$row_params = array(
	...
	array(
		"type" => 'dropdown',
		"heading" => esc_html__("Columns Height", 'uncode-core') ,
		"param_name" => "equal_height",
		"description" => esc_html__("Activate this feature to adjust the height of your columns. The Equal Height option ensures that all columns are as tall as the tallest column. The Justify option distributes the height of the inner row to fill the available space in the parent row. NB. Working on mobile is limited.", 'uncode-core') ,
		"value" => array(
			esc_html__('Disabled', 'uncode-core') => '',
			esc_html__('Equal height', 'uncode-core') => 'yes',
	...
	array(
		...
		"options" => array(
			...
			"gradient-soft" => array( esc_html__('Gradient Soft', 'uncode-core') => get_template_directory_uri()."/library/img/dividers/gradient-soft.svg"),
			"gradient-strong" => array( esc_html__('Gradient Strong', 'uncode-core') => get_template_directory_uri()."/library/img/dividers/gradient-strong.svg"),
		),
		"dependency" => array(
	...
	array(
		...
		"options" => array(
			...
			"gradient-soft" => array( esc_html__('Gradient Soft', 'uncode-core') => get_template_directory_uri()."/library/img/dividers/gradient-soft-inv.svg"),
			"gradient-strong" => array( esc_html__('Gradient Strong', 'uncode-core') => get_template_directory_uri()."/library/img/dividers/gradient-strong-inv.svg"),
		),
		"dependency" => array(
			'element' => "shape_top_invert",
			'not_empty' => true
	...
	array(
		"type" => "checkbox",
		"heading" => esc_html__("Parallax Safe", 'uncode-core') ,
		"param_name" => "content_parallax_safe",
		"description" => esc_html__("The parallax effect is disabled if the content is taller than the viewport, as otherwise, part of the content would remain permanently hidden from the user.", 'uncode-core') ,
		"group" => esc_html__("Extra", 'uncode-core'),
		"value" => Array(
			'' => 'yes'
		) ,
		"dependency" => array(
			'element' => "content_parallax",
