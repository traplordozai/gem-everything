...
function($) {
    ...
    window.vc_iframe.showNoContent = function(show) {
        ...
        this.$shortcodes_custom_css = $("head > [data-type=vc_shortcodes-default-css]"), this.$shortcodes_custom_css.length || (this.$shortcodes_custom_css = $('<style data-type="vc_shortcodes-default-css"></style>').prependTo("head"));
        var cssContent = this.$shortcodes_custom_css[0].innerHTML;
        cssContent && -1 !== cssContent.indexOf(elementClass) || this.$shortcodes_custom_css.append(css)
