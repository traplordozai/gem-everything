    ...
    function(d) {
        ...
        var r = Backbone.View.extend({
            ...
            h = (window.i18nLocale, vc.edit_form_callbacks = [], vc.atts = {
                ...
                init: function(e, t) {
                    d(".vc_color-control", t).each(function() {
                        var a, i, o = d(this),
                            e = o.val().replace(/\s+/g, ""),
                            t = 100;
                        e.match(/rgba\(\d+\,\d+\,\d+\,([^\)]+)\)/) && (t = 100 * parseFloat(e.match(/rgba\(\d+\,\d+\,\d+\,([^\)]+)\)/)[1])), o.wpColorPicker({
                            clear: function(e) {
                                a.val(100), i.val("100%"), e && e.originalEvent && e.originalEvent.isTrusted && "click" === e.type && d(this).trigger("change")
                            },
                            change: _.debounce(function() {
                                d(this).trigger("change")
                            }, 200)
                        }), e = o.closest(".wp-picker-container"), d('<div class="vc_alpha-wrapper"><div class="vc_alpha-container"><label>Alpha: <output class="rangevalue">' + t + '%</output></label><input type="range" min="1" max="100" value="' + t + '" name="alpha" class="vc_alpha-field"></div></div>').appendTo(e.addClass("vc_color-picker").find(".iris-picker")), a = e.find(".vc_alpha-field"), i = e.find(".vc_alpha-container output"), a.on("change keyup", function() {
                            var e = parseFloat(a.val()),
                                t = o.data("a8c-iris"),
                                n = o.data("wp-wpColorPicker");
                            i.val(a.val() + "%"), t._color._alpha = e / 100, o.val(t._color.toString()), n.toggler.css({
                                backgroundColor: o.val()
                            })
                        }).val(t).trigger("change")
                    }), document.querySelectorAll(".wp-picker-container .wp-color-result").forEach(function(t) {
                        t.addEventListener("click", function() {
                            var e = t.closest(".wp-picker-container").querySelector(".wp-picker-holder");
                            e && e.scrollIntoView({
                                behavior: "smooth",
                                block: "center"
                            })
...
! function(l) {
    _.isUndefined(window.vc) && (window.vc = {}), l.ajaxSetup({
        ...
        if (!this.active_panel || (l('body').hasClass('vc-sidebar-switch') && (vc.active_panel.model === false || (typeof e !== 'undefined' && typeof e.is !== 'undefined' && e.is('#vc_ui-panel-templates') && vc.active_panel.model.get("id") !== 'vc_ui-panel-templates')))) return !1;	
        // END UNCODE Edit
        ...
        fixElContainment: function() {
            // START UNCODE EDIT	
            if (l('body').hasClass('vc-sidebar-switch')) {	
                this.setSize()	
                return;	
            }	
            // END UNCODE EDIT	
    ...
    window.vc.element_start_index = 0, window.vc.AddElementUIPanelBackendEditor = vc.PanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).extend({
        ...
        createElement: function(e) {
            ...
            // }, this)), this.model = this.builder.last(), window.vc.latestAddedElement = this.model, n = !(_.isBoolean(vc.getMapped(s).show_settings_on_create) && !1 === vc.getMapped(s).show_settings_on_create), this.hide(), n && this.showEditForm(), this.builder.render(null, this.model)
                ...
                if (("vc_row" === s || "uncode_slider" === s || "vc_tabs" === s || "vc_accordion" === s || "vc_section" === s || "rev_slider" === s || "woocommerce_cart" === s || "woocommerce_checkout" === s || "woocommerce_order_tracking" === s) && l('body').hasClass('vc-sidebar-switch')) {
                    this.render()
                }
            // END UNCODE EDIT
        }
    ...
    window.vc.EditElementPanelView = vc.PanelView.vcExtendUI(vc.HelperAjax).vcExtendUI(vc.ExtendPresets).vcExtendUI(vc.ExtendTemplates).vcExtendUI(vc.HelperPrompts).extend({
        ...
        buildParamsContent: function(e) {
            var t, n, i = this.model.get("id"),
                ...
                s = 0,
                c = function() {
                    !window.wpb_edit_form_loaded && s < 10 ? (s++, setTimeout(c, 100)) : (a.$content.removeAttr("data-vc-param-initialized"), a.active_tab_index = 0, a.tabsInit = !1, a.panelInit = !1, a.dependent_elements = {}, a.requiredParamsInitialized = !1, a.$content.find("[data-vc-param-initialized]").removeAttr("data-vc-param-initialized"), n.removeClass("visually-hidden"), a.$content.find(".vc_ui-wp-spinner").remove(), a.init(), a.$content.parent().scrollTop(1).scrollTop(0), a.$content.removeClass("vc_properties-list-init"), a.$el.trigger("vcPanel.shown"), a.trigger("afterRender"))
                };
    ...
    function(l) {
        vc.map = {}, vc.setFrameSize = function(e) {
            var t = l("#vc_navbar"),
                ...
                vc_navbar_height = l('body').hasClass('vc-sidebar-switch') ? 0 : t.height(),
                n = l(window).height() - vc_navbar_height,	
                max_height,	
                iframe_top;
            ...
            edit: function(e) {
                // START UNCODE EDIT	
                l(document.body).trigger('edit-block-window')	
                // END UNCODE EDIT
            ...
            openTemplatesWindow: function(e) {
                // START UNCODE EDIT	
                l(document.body).trigger('open-templates-window')	
                // END UNCODE EDIT
            ...
            render: function() {
                ...
                })), l(vc.$frame.get(0).contentWindow.document).find(".wpb-content-wrapper").length || window.vc.showMessage(window.i18nLocale.not_editable_post || "This post can not be edited with WPBakery since it is missing a WordPress default content area.", "error", "30000"), this
            },
...
! function(i) {
    window.vc.cloneMethod_vc_tab = function(t, e) {
        ...
        stopSorting: function(t, e) {
            this.tabsControls().find("> li").each(function(t, e) {
        ...
        placeElement: function(t, e) {
            ...
            t.attr("id", t.data("id"))	
            i && i.get("place_after_id") ? (t.insertAfter(window.vc.$page.find("[data-model-id=" + i.get("place_after_id") + "]")), i.unset("place_after_id")) : t.appendTo(this.content()), this.changed()	
            // END UNCODE EDIT	
        },
